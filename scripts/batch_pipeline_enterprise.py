...
df_curated = df_transformed.groupBy("category").agg(
...
df_avg_transaction = df_transformed.groupBy("customer_id").agg(
...
df_avg_transaction.write.mode("overwrite").parquet(
    "data/curated/avg_transaction/"
)

print("Saving Partitioned Data...")

df_transformed.write.mode("overwrite").partitionBy("category").parquet(
